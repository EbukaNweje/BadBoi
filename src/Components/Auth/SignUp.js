    ...
    <Container>
      <Wrapper>
        <Card>
          ...
          <Span>
            Already have an account? <Span2 to="/login">Login</Span2>
          </Span>
          ...
          <Form onSubmit={(e) => Siginup(e)}>
            <Label>
              <MdPersonAddDisabled style={{ marginRight: "2%" }} />
              Full Name*
            </Label>
            <Input
              type="text"
            ...
            />
            <Label>
              <MdPersonSearch style={{ marginRight: "2%" }} />
              Username*
            </Label>
            <Input
              type="text"
            ...
            />
            <Label>
              <MdPhoneEnabled style={{ marginRight: "2%" }} />
              Phone Number*
            </Label>
            <Input
              type="tel"
            ...
            />
            <Label>
              <BsFillLockFill style={{ marginRight: "2%" }} />
              Password*
            </Label>
            <Input
              type="password"
            ...
            <PassWordText>
              The password may include Latin, Cyrillic, numbers and special
              characters
            </PassWordText>
            <PassWordError>
              <MdOutlineErrorOutline
                style={{ marginRight: "2%", fontSize: "50px" }}
              />
              At least 8 characters, the password must contain uppercase and
